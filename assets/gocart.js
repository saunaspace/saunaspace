        ...
        for (
          ...
          if (
            ...
            if (
              ...
              if (
                ("checkbox" !== u.type || u.checked || (h = ""),
                "radio" === u.type &&
                  (c[u.name] || u.checked
                    ? u.checked && (c[u.name] = !0)
                    : (c[u.name] = !1)),
                void 0 == h && "radio" == u.type)
              )
                continue;
            } else if (!h) continue;
            if ("select-multiple" !== u.type) r = i(r, d, h);
            else {
              h = [];
              for (var f = u.options, y = !1, p = 0; p < f.length; ++p) {
                var m = f[p],
                  b = e.empty && !m.value,
                  v = m.value || b;
                m.selected &&
        ...
        function GoCart(t) {
          ...
          (this.defaults = Object.assign(
            {},
            {
              ...
              cartSubtotal: ".go-cart-mini-cart__subtotal",
            ...
            (this.cartSubtotal = document.querySelector(
              this.defaults.cartSubtotal
            )),
            ...
            (this.cartBubbleCartSubTotal = document.querySelector(
              this.defaults.cartBubbleCartSubTotal
            )),
            (this.cartMiniCartFooter = document.querySelector(
              this.defaults.cartMiniCartFooter
            )),
            (this.addedToCart = document.querySelector(
              this.defaults.addedToCart
            )),
            ...
            (this.cartClose = document.querySelector(this.defaults.cartClose)),
            (this.cartCount = document.querySelector(this.defaults.cartCount)),
            (this.cartCountSubtotal = document.querySelector(
              this.defaults.cartCountSubtotal
            )),
          ...
          (e = [
                  ...
                  document.addEventListener(
                    ...
                    function (e) {
                      if (e.target.matches(t.defaults.addToCart)) {
                        ...
                        var r = e.target.closest("form").getAttribute("id");
                        t.addItemToCart(r);
                      }
                    },
                    !1
                  ...
                  this.cartOverlay.addEventListener("click", function () {
                    t.closeFailModal(),
                      ...
                      t.isDrawerMode
                        ? t.closeCartDrawer()
                        : (t.closeMiniCart(),
                          t.addedToCart.classList.remove("is-open")),
                      t.closeCartOverlay();
                  }),
                  this.cartClose.addEventListener("click", function () {
                    t.closeFailModal(),
                      t.closeCartModal(),
                      t.isDrawerMode
                        ? t.closeCartDrawer()
                        : (t.closeMiniCart(),
                          t.cartMiniCart.classList.remove("is-open"),
                          t.addedToCart.classList.remove("is-open")),
                      t.closeCartOverlay();
                  }),
                  this.isDrawerMode &&
            ...
            },
            {
              ...
              value: function (t) {
                ...
                console.log("data!");
                console.log(a);
                console.log(a._optionalVariants);
                const uniqueID = generateUniqueID();
                var optinal = a._optionalVariants;
                  window.fetch("/cart/add.js", {
                    ...
                    .then(function (t) {
                      // setTimeout(() => {
                        if(optinal !== "empty"){
                          e.optinaladdcart(optinal, uniqueID);
                        }
                        else{
              ...
              value: function (t) {
                0 != t.item_count
                  ? ((this.cartCount.innerHTML = "(" + t.item_count + ")"),
                    (this.cartCountSubtotal.innerHTML =
                      "(" + t.item_count + ")"))
                  : ((this.cartCount.innerHTML = "  "),
                    (this.cartBubbleCartSubTotal.innerHTML = ""));
              },
            },
            {
              ...
              value: function () {
                ...
                this.fetchCart(function () {
                  t.isDrawerMode
                    ? t.openCartDrawer()
                    : (t.openMiniCart(),
                      t.addedToCart.classList.add("is-open")),
                    t.openCartOverlay();
                });
              },
            },
            ...
            },
            {
              key: "fetchHandler",
              value: function (t, e) {
                console.log("cart render " + t.item_count),
                  ...
                  this.isDrawerMode
                    ...
                    : (this.renderMiniCart(t),
                      ...
                      this.cartMiniCartSubTotal.parentNode.parentNode.parentNode.parentNode.classList.remove(
                        "cart-is-empty"
                      ),
                      "function" === typeof e && e(t));
              },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                t.variant_name, (e = null === e ? "" : "(".concat(e, ")"));
                var r =
            ...
            },
            {
              ...
              value: function (t) {
                ...
                this.clearCartDrawer(),
                  ...
                  this.cartSubtotal.parentNode.classList.remove("is-invisible"),
                  document
            ...
            {
              key: "optinaladdcart",
              value: function(optinal, uniqueID ){
                var e = this;
...
},
            {
              ...
              value: function (t) {
                ...
                this.clearMiniCart(),
                  t.items.forEach(function (t, r) {
                    var a = t.options_with_values
                        .map(function (t) {
                          return "Default Title" == t.value
                            ? void 0
                            : '<div class="go-cart-item__variant"><strong>'
                                .concat(t.name, ": </strong> ")
                                .concat(t.value, "</div>");
                        })
                        .join(""),
                      o = t.variant_title;
                    t.options_with_values[0].name, null === o && (o = "");
                    var n =
                      '\n        <div class="go-cart-item__single" data-line="'
                        .concat(
                          Number(r + 1),
                  ...
                  (this.cartBubbleCartSubTotal.innerHTML = formatMoney(
                    t.total_price,
                    this.moneyFormat
                  )),
            ...
            },
            {
              ...
              value: function () {
                this.cartDrawerSubTotal.parentNode.classList.add(
                  ...
                  this.clearCartDrawer(),
                  this.cartSubtotal.classList.add("is-invisible"),
            ...
            },
            {
              ...
              value: function () {
                this.cartMiniCartSubTotal.parentNode.parentNode.parentNode.parentNode.classList.add(
                  "cart-is-empty"
                ),
                  this.clearMiniCart(),
                  this.cartSubtotal.classList.add("is-invisible"),
            ...
            },
            {
              key: "closeMiniCart",
              value: function () {
                console.log("close mini cart called"),
                  console.log(this.cartMiniCart),
...
function generateUniqueID() {
  ...
  // Additional string to add for uniqueness (you can customize this)
  const additionalString = 'UNIQUE';

  // Generate a random number to further ensure uniqueness
  const randomNumber = Math.floor(Math.random() * 1000);

  // Concatenate timestamp, additional string, and random number
